...
| `SECURITY_JWT_SECRET` | JWT signing secret | change-me-super-secret-key-please |
| `APP_CORS_ALLOWED_ORIGINS` | Allowed CORS origins | * |
| `N8N_WEBHOOK_URL` | N8N webhook URL (optional) | - |
| `ADMIN_SEED_ENABLED` | Enable admin user seeding | true |
| `ADMIN_SEED_EMAIL` | Admin email | admin@gmail.com |
| `ADMIN_SEED_PASSWORD` | Admin password | 123456 |
