...
export default function AdminPostJob() {
  ...
  function validate(values) {
    ...
    if (values.skillScoreThreshold < 0 || values.skillScoreThreshold > 100) e.skillScoreThreshold = "Threshold must be 0-100";
    return e;
  }
    ...
    <div className="fade-in">
      ...
      <div className="card">
        <form className="form" onSubmit={submit}>
          ...
          <div className="row cols-2">
            <div className="field">
              <label>Skill Score Threshold</label>
              <input name="skillScoreThreshold" type="number" min="0" max="100" value={form.skillScoreThreshold} onChange={(e) => setForm({ ...form, skillScoreThreshold: Number(e.target.value) })} />
              <small>Minimum AI score (0-100) required to pass initial screening.</small>
              {errors.skillScoreThreshold && <small className="text-error">{errors.skillScoreThreshold}</small>}
            </div>
            <div className="field">
